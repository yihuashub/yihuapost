        ...
        <section class="content">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (!empty($_POST["post-type"])) {
                    ...
                    if ($_POST["post-type"] == 2 && !empty($_POST["post-id"])) {
                        $postId= $_POST["post-id"];
                        $newPost->newPostById($postId);
                        $options = $newPost->getOptions();
                    }
                    else if($_POST["post-type"] == 3 && !empty($_POST["post-id"]))
                    {
                        $mID = $_POST["post-id"];
                        ...
                        if ($newPost->updatePost($options,$mID)) {
                            $successPost = 1;
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-sm-offset-11 col-sm-1">
                            ...
                            <button type="submit" class="btn btn-primary" form="saveForm">修改文章</button>
                        </div>
                    </div>
                </div>
                </form>
