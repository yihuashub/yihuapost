            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (!empty($_POST["post-type"])) {
                    ...
                    if($_POST["post-type"]==1)
                    {
                        ...
                        //TODO for index of include in late version
                        ...
                        if($check)
                        {
                            ...
                            $sql = "INSERT INTO web_house (`ID`, `house_ID`, `type`, 
`is_apt`, `title`, `title_en`, `price`, `apt_number`, `add_number`, `add_name`, `add_suffix`, `city`, `province`, 
`country`, `post_code`, `lat`, `long`, `basement`, `parking`, `include`, `development`, `house_type`, `house_bedroom`, 
`house_bathroom`, `house_sqft`, `house_year`, `description_cn`, `description_en`, `main_pic`, `status`, `author`, `date`) 
VALUES (NULL, '0', '$sellType', '$isApt', '$title', '$titleEn', '$price', '$aptNumber', '$addNumber', '$addName', 
'$addSuffix', '$city', '$province', '$country', '$postCode', '$latitude', 
'$longitude', '$houseBasement', '$parking', '$include', '$development', '$houseType', '$houseBedroom', '$houseBathroom', '$houseSqft', 
'$houseYear', '$descriptionCn', '$descriptionEn', '0', '0', '$author','$date')";
            ...
            <div class=\"box\">
                ...
                <form class=\"form-horizontal\" method=\"post\" action=\"$server\">
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-sm-10\">
                                <select class=\"form-control\" name=\"sell-type\">
                                    <option value=\"2\" >出售(For Sell)</option>
                                    <option value=\"3\" >促销(Promotion)</option>
                                    <option value=\"1\" >已售(Sold)</option>
                                </select>
                            </div>
                        </div>
                        <div class=\"form-group\">
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-sm-10\">
                                <div class=\"form-inline\">
                                    ...
                                    <input type=\"text\" class=\"form-control\" id=\"address-number\" name=\"add-number\" placeholder=\"Add. number\" required/>
                                    <input type=\"text\" class=\"form-control\" id=\"address-name\" name=\"add-name\" placeholder=\"Add. name\" required/>
                                    <input type=\"text\" class=\"form-control\" id=\"address-suffix\" name=\"add-suffix\" placeholder=\"Add. suffix\" data-provide=\"typeahead\" data-items=\"4\" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-sm-10\">
                                <div class=\"form-inline\">
                                    ...
                                    <input value=\"Winnipeg\" type=\"text\" class=\"form-control\"  name=\"city\" placeholder=\"City\" id=\"city-list\" data-provide=\"typeahead\" data-items=\"4\" required/>
                                    <label for=\"province-list\">省/州：</label>
                                    <input value=\"Manitoba\"type=\"text\" class=\"form-control\" name=\"province\" placeholder=\"Province / State\" id=\"province-list\" data-provide=\"typeahead\" data-items=\"4\" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-sm-10\">
                                <div class=\"form-inline\">
                                    ...
                                    <input value=\"Canada\" type=\"text\" class=\"form-control\" name=\"country\" placeholder=\"Country\" id=\"country-list\" data-provide=\"typeahead\" data-items=\"4\" required/>
                                    <label for=\"province-list\">邮编：</label>
                                    <input type=\"text\" id=\"post-code\" class=\"form-control\" name=\"post-code\" placeholder=\"Post Code\" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-sm-10\">
                                <input class=\"form-control\" name=\"sqft\" type=\"number\" required>
                            </div>
                        </div>";
                ...
                echo" </select>
                       ...
                       echo  "
                        <div class=\"form-group\">
                            ...
                            <div class=\"col-sm-10\">
                                <textarea class=\"form-control\" id=\"note\" name=\"description-cn\" rows=\"3\" required></textarea>
                            </div>
                        </div>
                        <div class=\"form-group\">
                            <label class=\"col-sm-2 control-label\">英文介绍</label>
                            <div class=\"col-sm-10\">
                                <textarea class=\"form-control\" id=\"note\" name=\"description-en\" rows=\"3\" required></textarea>
                            </div>
                        </div>
                <!-- /.box-body -->
                <div class=\"box-footer\">
